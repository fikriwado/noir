  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen w-full flex flex-col items-center justify-center pt-28 sm:pt-32 pb-16 mb-52">
      <Container>
        ...
        >
          ...
          <motion.div style={{ y: subY }} className="relative z-20">
            <motion.p
              variants={itemVariants}
               className="mt-6 max-w-xl text-center text-base md:text-lg lg:text-[22px] leading-relaxed font-[family-name:var(--font-body)] text-zinc-300 px-6 sm:px-0"
            >
      ...
      <motion.div
        ...
        style={{ y: exploreY }}
        className="hidden sm:flex absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex justify-center items-center pointer-events-none select-none z-0"
      >
        <span className="font-[family-name:var(--font-heading)] text-[25vw] md:text-[20vw] lg:text-[25vw] font-black uppercase tracking-tighter whitespace-nowrap leading-none opacity-5 md:opacity-10 lg:opacity-[0.02] select-none">
          EXPLORE
        </span>
      </motion.div>
