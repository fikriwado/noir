...
export default function Section({ id, title, children, className = "", viewMoreHref, hideViewMore }) {
  return (
    <section id={id} className={`relative w-full py-24 sm:py-32 ${className}`}>
      <Container>
        {title && (
          <div className="group flex items-center gap-6 mb-10">
