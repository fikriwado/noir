    ...
    <Section id="about" title="About Me" hideViewMore={isInnerPage} viewMoreHref={isInnerPage ? undefined : "/about"} className="pt-40 sm:pt-52">
      <div ref={sectionRef} className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
        <div className="lg:col-span-7 flex flex-col gap-6">
          <Reveal>
            <motion.p style={{ y: p1Y }} className="text-base md:text-lg lg:text-xl text-[#f0f0f0] lg:font-light leading-relaxed">
          ...
          <Reveal delay={0.1}>
            <motion.p style={{ y: p2Y }} className="text-base md:text-lg lg:text-xl text-[#f0f0f0] lg:font-light leading-relaxed">
